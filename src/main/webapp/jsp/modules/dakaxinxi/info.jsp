            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">打卡信息登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="xueshengId" name="xueshengId" v-model="ruleForm.xueshengId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="dakaxinxiTiwen" name="dakaxinxiTiwen" class="form-control"
                                               v-model="ruleForm.dakaxinxiTiwen" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="dakaxinxiDidian" name="dakaxinxiDidian" class="form-control"
                                               v-model="ruleForm.dakaxinxiDidian" readonly>
                                    </div>
