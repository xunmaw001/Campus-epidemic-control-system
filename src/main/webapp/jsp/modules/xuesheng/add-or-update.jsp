                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 xueshengTypesDiv">
                                        <label>学生状态</label>
                                        <select id="xueshengTypesSelect" name="xueshengTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationXueshengtypesSelect(){
            var xueshengTypesSelect = document.getElementById('xueshengTypesSelect');
            if(xueshengTypesSelect != null && xueshengTypesOptions != null  && xueshengTypesOptions.length > 0 ){
                for (var i = 0; i < xueshengTypesOptions.length; i++) {
                    xueshengTypesSelect.add(new Option(xueshengTypesOptions[i].indexName,xueshengTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(xueshengTypesSelect != null && xueshengTypesOptions != null  && xueshengTypesOptions.length > 0 ) {
            for (var i = 0; i < xueshengTypesOptions.length; i++) {
                if (xueshengTypesOptions[i].codeIndex == ruleForm.xueshengTypes) {//下拉框value对比,如果一致就赋值汉字
                        xueshengTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationXueshengtypesSelect();
            <!--  初始化级联表的下拉框  -->
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $("#xueshengTypesSelect").attr("disabled","disabled")
        }
        else{
            // alert("未知情况.......");
