    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">一月内是否接触过确诊病例管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">一月内是否接触过确诊病例管理</li>
                        <li class="breadcrumb-item active">一月内是否接触过确诊病例列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">一月内是否接触过确诊病例列表</h3>
                        <div class="table-responsive mb-3">
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" id="indexNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                               placeholder="一月内是否接触过确诊病例名称" aria-controls="tableId">
                                    </div>
                                </div>
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th >一月内是否接触过确诊病例编码</th>
                                    <th >一月内是否接触过确诊病例名称</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody id="thisTbody">
...
<script>
    ...
    var tableName = "dictionaryQuezhen";
    var pageType = "list";
    var searchForm = {key: ""};
    var pageIndex = 1;
    var pageSize = 10;
    ...
    function getDataList() {
        http("dictionary/page", "GET", {
            ...
            order: sortOrder,
            //本表的
            dicCode: "quezhen_types",//编码名字
            dicName: "一月内是否接触过确诊病例名称",//汉字名字
