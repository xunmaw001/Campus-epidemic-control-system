	...
	<div class="page-form">
        <form id="loginForm" action="" method="post" class="form">
            ...
            <div class="body-content">
                ...
                <div id="submitBtn" class="form-group"><button type="submit" class="btn btn-success"  style="width: 100%;background-color:var(--subColor, #F37335);color: #FFFFFF;"  onclick="login()">登 录</button></div>
				<div class="form-group"><button type="button" class="btn btn-success"  style="width: 100%;background-color:var(--subColor, #F37335);color: #FFFFFF;"  onclick="window.location.href='./modules/xuesheng/register.jsp'">注册  学生</button></div>
