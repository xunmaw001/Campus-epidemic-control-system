            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">防疫科普展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="fangyikepuName" id="fangyikepuName" placeholder="标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <ul>
                            <li v-for="(item,index) in dataList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jump('../fangyikepu/detail.jsp?id='+item.id)">
                                        <a href="#" class="ng-prsliik">
                                            <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                                <img class="swiper-item" :src="item.fangyikepuPhoto?item.fangyikepuPhoto.split(',')[0]:''" />
                                            </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jump('../fangyikepu/detail.jsp?id='+item.id)"><span>{{item.fangyikepuName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.fangyikepuNewMoney"><span style="color: red;">{{item.fangyikepuNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#fangyikepuName').val() != null && jquery('#fangyikepuName').val() != "" && jquery('#fangyikepuName').val() != "null" ) {
                param['fangyikepuName'] = jquery('#fangyikepuName').val();
            }
                                        
            // 获取列表数据
            http.request('fangyikepu/list', 'get', param, function(res) {
