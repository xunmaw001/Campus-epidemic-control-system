	...
	<body style="background: #EEEEEE;">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="fangyikepuName" id="fangyikepuName" lay-verify="required" placeholder="标题" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="fangyikepuPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="fangyikepuPhoto" name="fangyikepuPhoto"/>
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`fangyikepu/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#fangyikepuPhotoImg").attr("src", data.data.fangyikepuPhoto);
                });
