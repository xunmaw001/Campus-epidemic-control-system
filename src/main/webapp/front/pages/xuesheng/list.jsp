            ...
            <div class="ng-inmod-ini">
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="xueshengTypes" id="xueshengTypes" lay-filter="xueshengTypes">
                                  <option value="">--请选择--</option>
...
<script>
    ...
    // 当前表的字典表
        ...
        function xueshengTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=xuesheng_types", 'get', {}, function (res) {
                if(res.code == 0){
        ...
        function pageList() {
            ...
            var xueshengTypes = $("#xueshengTypes").find("option:selected").val();
            if (xueshengTypes != null && xueshengTypes != "" && xueshengTypes != "null") {
                param['xueshengTypes'] = xueshengTypes;
            }
