...
<!-- 身份证号 -->
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input <%--v-model="detail.xueshengIdNumber"--%> type="text" name="xueshengIdNumber" id="xueshengIdNumber"  lay-verify="identity|required"   placeholder="身份证号" autocomplete="off" class="layui-input">
                </div>
            </div>
    <!-- 手机号 -->
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input <%--v-model="detail.xueshengPhone"--%> type="text" name="xueshengPhone" id="xueshengPhone"  lay-verify="phone|required"   placeholder="手机号" autocomplete="off" class="layui-input">
                </div>
            </div>
