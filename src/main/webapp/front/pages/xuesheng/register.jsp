...
<!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="xueshengIdNumber" id="xueshengIdNumber"  lay-verify="identity|required"   placeholder="身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="xueshengPhone" id="xueshengPhone"  lay-verify="phone|required"   placeholder="手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <input type="hidden" name="xueshengTypesSelect" value="1">
